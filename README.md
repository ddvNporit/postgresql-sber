...
##   Настройка перед использованием
 ...
 1. Конфигурационный файл .env
  ...
  Создайте файл `.env` в корне проекта со следующей структурой:
      ...
      # DB_DEFAULT_TABLE - имя таблицы, по которой будет проверяться доступнасть базы данных (эта таблица должна быть доступна пользователю login в базе данных test_BD)
      
      ```
    

2. В базе данных должны быть настроены права для пользователя. Таблица People должна быть создана

3. Требования к таблице People:
